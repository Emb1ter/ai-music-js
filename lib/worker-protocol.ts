...
export type StartRequest = {
  ...
  /** Exact 5 Hz ACE codebook indices generated by the optional planner. */
  semanticCodeIds?: number[];
  /** Metadata paired with semanticCodeIds by the ACE planner. */
...
/** Normalized, monotonic progress for the current public library operation. */
export type ProgressUpdate = {
  type: "progress";
  /** Always a finite number from 0 through 1, inclusive. */
  progress: number;
...
export type LyricsCompleteUpdate = {
...
export type PlanCompleteUpdate = {
  type: "plan-complete";
  plannerQuality: PlannerQuality;
  semanticCodeIds: number[];
  metadata: {
  ...
  seed: number;
  timings: Record<string, number>;
  /** Detailed production-planner timings and input fingerprints, when available. */
  plannerProfile?: PlannerProfileReport;
};

export type PlannerProfileUpdate = {
  type: "planner-profile";
  report: PlannerProfileReport;
};
